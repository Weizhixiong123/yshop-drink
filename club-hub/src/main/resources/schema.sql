...
CREATE TABLE IF NOT EXISTS staff (
    ...
    role        VARCHAR(20)  NOT NULL DEFAULT 'staff' COMMENT '角色: owner=店东, staff=店员',
...
-- 初始化店东账号（默认密码: admin123）
INSERT INTO staff (username, password, name, role, status) VALUES
('admin', 'admin123', '店东', 'owner', 1);
